	...
	init: function(){
		...
		var addPokemonPlaceholders = function( items ) {
			...
			for (var i = 0; i < items; i++) {
				...
				pList += '<li class="pokemon__info-name"><h2>' + pokemonList.results[i].name + '</h2></li>';
		...
		var updatePokemonEvolutionInfo = function(id, name) {
			...
			$item.find('.pokemon__info-evolution').html('<span class="pokemon__info-evolution-label">Evoluciona de: </span><h3 class="pokemon__info-evolution-name">' + name + '</h3>');
		};
